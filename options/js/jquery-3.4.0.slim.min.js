/*! jQuery v3.4.0 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector | (c) JS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
    "use strict";
    ...
    var h = function (n) {
        ...
        return me.prototype = x.filters = x.pseudos, x.setFilters = new me, h = se.tokenize = function (e, t) {
            ...
            if (!a) {
                ...
                (a = A(e, (v = o, m = 0 < (y = i).length, b = 0 < v.length, r = function (e, t, n, r, i) {
                    var o, a, s, u = 0,
                        l = "0",
                        c = e && [],
                        f = [],
        ...
        o ? (G.set(e, i, !1), E.event.add(e, i, {
            ...
            handler: function (e) {
                ...
                if (1 & e.isTrigger && this[i]) {
                    if (r)(E.event.special[i] || {}).delegateType && e.stopPropagation();
                    else if (r = s.call(arguments), G.set(this, i, r), t = o(this, i), this[i](), r !== (n = G.get(this, i)) || t ? G.set(this, i, !1) : n = void 0, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n
